...
struct ButcherABP_C_AnimGraph final
{
public:
	struct FPoseLink                              AnimGraph_0;                                       // 0x0000(0x0010)(Parm, OutParm, NoDestructor)
};
DUMPER7_ASSERTS_ButcherABP_C_AnimGraph;

// Function ButcherABP.ButcherABP_C.ExecuteUbergraph_ButcherABP
// 0x0090 (0x0090 - 0x0000)
struct ButcherABP_C_ExecuteUbergraph_ButcherABP final
{
public:
	...
	float                                         CallFunc_MakeRotator_Yaw_ImplicitCast_2;           // 0x0088(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_ButcherABP_C_ExecuteUbergraph_ButcherABP;
