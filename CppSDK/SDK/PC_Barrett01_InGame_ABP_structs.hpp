...
// ScriptStruct PC_Barrett01_InGame_ABP.PC_Barrett01_InGame_ABP_C.AnimBlueprintGeneratedConstantData
// 0x018F (0x0190 - 0x0001)
struct PC_Barrett01_InGame_ABP::FAnimBlueprintGeneratedConstantData final : public FAnimBlueprintConstantData
{
public:
	...
	struct FAnimNodeExposedValueHandler_PropertyAccess AnimGraphNode_PoseDriver_1;                   // 0x0100(0x0030)()
	struct FAnimNodeExposedValueHandler_PropertyAccess AnimGraphNode_PoseDriver;                     // 0x0130(0x0030)()
	struct FAnimNodeExposedValueHandler_PropertyAccess AnimGraphNode_CopyPoseFromMesh;               // 0x0160(0x0030)()
};
DUMPER7_ASSERTS_PC_Barrett01_InGame_ABP__FAnimBlueprintGeneratedConstantData;
