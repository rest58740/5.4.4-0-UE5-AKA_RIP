...
{
public:
	class UChaosCacheCollection*                  CacheCollection;                                   // 0x0298(0x0008)(Edit, ZeroConstructor, DisableEditOnTemplate, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
