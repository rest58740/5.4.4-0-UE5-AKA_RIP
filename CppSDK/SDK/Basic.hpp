...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08645A70;
	constexpr int32 AppendString      = 0x01266CB0;
	constexpr int32 GNames            = 0x0852B548;
	constexpr int32 GWorld            = 0x087BDA08;
	constexpr int32 ProcessEvent      = 0x0145BAC0;
