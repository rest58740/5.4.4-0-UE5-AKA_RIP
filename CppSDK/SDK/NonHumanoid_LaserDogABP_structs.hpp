...
// ScriptStruct NonHumanoid_LaserDogABP.NonHumanoid_LaserDogABP_C.AnimBlueprintGeneratedConstantData
// 0x0257 (0x0258 - 0x0001)
struct NonHumanoid_LaserDogABP::FAnimBlueprintGeneratedConstantData final : public FAnimBlueprintConstantData
{
public:
	...
	bool                                          __BoolProperty_35;                                 // 0x0038(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         __FloatProperty_36;                                // 0x003C(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FInputScaleBiasClampConstants          __StructProperty_37;                               // 0x0040(0x002C)(BlueprintVisible, NoDestructor)
	float                                         __FloatProperty_38;                                // 0x006C(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_NonHumanoid_LaserDogABP__FAnimBlueprintGeneratedConstantData;

// ScriptStruct NonHumanoid_LaserDogABP.NonHumanoid_LaserDogABP_C.AnimBlueprintGeneratedMutableData
// 0x0007 (0x0008 - 0x0001)
struct NonHumanoid_LaserDogABP::FAnimBlueprintGeneratedMutableData final : public FAnimBlueprintMutableData
{
public:
...
DUMPER7_ASSERTS_NonHumanoid_LaserDogABP__FAnimBlueprintGeneratedMutableData;
